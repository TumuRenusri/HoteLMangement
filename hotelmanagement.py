...
def Booking():
    ...
    cii = str(input("Check-In(date/month/year): "))
    checkin.append(cii)
    cii = cii.split('/')
    ci = cii
    ci[0] = int(ci[0])
    ...
    coo = str(input("Check-Out(date/month/year): "))
    checkout.append(coo)
    coo = coo.split('/')
    co = coo
    co[0] = int(co[0])
    ...
    if p1 not in phno:
        ...
        for n in range(0, i):
            if p1 == phno[n]:
                if p[n] == 0:
                    print(
                        "\tPhone no. already exists and payment yet not done..!!"
                    )
                    name.pop(i)
                    add.pop(i)
                    checkin.pop(i)
            ...
            while (ch != 0):
                ...
                if ch == 1 or ch == 31 or ch == 32:
                    ...
                    r = r + rs
                      ...
                      and ch >= 11) or ch == 35 or ch == 36 or ch == 38:
                    rs = 110
                    r = r + rs
